...
var bio = {
	...
	paragraph2: 'I am also a proud alum of General Assembly\'s Web Development Immersive program. I find the rapid evolution of technology fascinating. As the web continues in the direction of single page applications, exploring solutions and strategies for building these rich front-end apps is not only essential but provides an exciting opportunity for design innovation.'
	};
