...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Contact = __webpack_require__(295);
	...
	_reactDom2.default.render(_react2.default.createElement(_Spinner2.default, null), document.getElementById('kurt-loader'));

	var router = _react2.default.createElement(
	  _reactRouter.Router,
	  { history: (0, _history.createHashHistory)({ queryKey: false }) },
	  _react2.default.createElement(
	    _reactRouter.Route,
	    { component: _App2.default, path: '/' },
	    _react2.default.createElement(_reactRouter.IndexRoute, { component: _Home2.default, name: 'home' }),
	    _react2.default.createElement(_reactRouter.Route, { component: _about.About, path: 'about', name: 'about' }),
	    _react2.default.createElement(_reactRouter.Route, { component: _Contact2.default, path: 'contact', name: 'contact' }),
	    _react2.default.createElement(_reactRouter.Route, { component: _Work2.default, path: 'work(/:id)', name: 'work' })
	  )
	);

	_reactDom2.default.render(router, document.getElementById('site-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _enableBeforeUnload2 = __webpack_require__(213);

	var _enableBeforeUnload3 = _interopRequireDefault(_enableBeforeUnload2);

	exports.enableBeforeUnload = _enableBeforeUnload3['default'];

	var _enableQueries2 = __webpack_require__(214);
	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      var route = nextProps.routes[1].name;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_header2.default, { page: this.state.page }),
	        this.props.children,
	        _react2.default.createElement(_footer2.default, { page: this.state.page })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  shouldApplyBlend: function shouldApplyBlend(props) {
	    return props.page === 'contact' ? _react2.default.createElement('div', { className: 'blend' }) : null;
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  onChildChanged: function onChildChanged(openState) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bind = __webpack_require__(222);
	...
	exports.default = _react2.default.createClass({
	  ...
	  getDefaultProps: function getDefaultProps() {
	    return {
	      visible: { 'right': '0' },
	      hidden: { 'right': '-21em' },
	      pages: [{ name: 'Home', route: '/', id: 1 }, { name: 'Work', route: 'work', id: 2 }, { name: 'About', route: 'about', id: 3 }, { name: 'Contact', route: 'contact', id: 4 }]
	    };
	  },
	  getInitialState: function getInitialState() {
	    return {
	  ...
	  setPageLinks: function setPageLinks(page) {
	  ...
	  render: function render() {
	    ...
	    var open = this.state.open ? this.props.visible : this.props.hidden;
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', { src: 'src/assets/images/site/ev-av.png' })
	      ),
	      _react2.default.createElement(
	        'nav',
	        null,
	        _react2.default.createElement(
	          'div',
	          { className: cx('burger-' + this.state.page), onClick: this.handleClick },
	          _react2.default.createElement('span', { className: 'fa fa-bars' })
	        ),
	        _react2.default.createElement(
	          'div',
	          { style: open, className: cx('menu') },
	          _react2.default.createElement(
	            'div',
	            { className: cx('menu-header') },
	            _react2.default.createElement(
	              'div',
	              { className: cx('menu-icon'), onClick: this.handleClick },
	          ...
	          _react2.default.createElement(
	            ...
	            this.props.pages.map(function (page, i) {
	              return _react2.default.createElement(
	                'li',
	                { key: i, className: cx('menu-item'), onClick: _this.handleClick },
	                _this.setPageLinks(page)
	              );
	            })
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getTechItems = getTechItems;
	exports.getRelativePath = getRelativePath;
	exports.setProjectThumbnails = setProjectThumbnails;
	exports.setProjectCarouselSlides = setProjectCarouselSlides;
	...
	var _tech = __webpack_require__(221);
	...
	function findTechByIds(ids) {
	  ...
	  try {
	    for (var _iterator = ids[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      try {
	        for (var _iterator2 = _tech2.default[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	...
	function getTechItems() {
	  return _tech2.default.filter(function (obj) {
	    return obj.featured;
	  }).map(function (obj) {
	    return obj;
	  });
	...
	function setProjectThumbnails(projects) {
	  return projects.map(function (project) {
	    var url = getRelativePath(project.thumbnail);
	    return {
	      id: project.id,
	      image: url
	    };
	...
	function setProjectCarouselSlides(images) {
...
/***/ function(module, exports) {
	...
	exports.default = [{
	  ...
	  images: ['images/apps/drive-1.png', 'images/apps/drive-2.png', 'images/apps/drive-3.png'],
	  featured: true,
	  techIds: [1, 13, 14, 20]
	}, {
	  name: 'Marshallz Blog',
	  ...
	  images: ['images/apps/marshallz-1.png', 'images/apps/marshallz-2.png', 'images/apps/marshallz-3.png', 'images/apps/marshallz-4.png'],
	  featured: true,
	  ...
	  images: ['images/apps/mim-1.png', 'images/apps/mim-2.png', 'images/apps/mim-3.png'],
	  featured: true,
	  ...
	  images: ['images/apps/bfs-1.png', 'images/apps/bfs-2.png'],
	  featured: true,
	  techIds: [21, 13]
	}, {
	  name: 'Ramen Buffet',
	  ...
	  images: ['images/apps/ramen-buffet-1.png', 'images/apps/ramen-buffet-2.png', 'images/apps/ramen-buffet-3.png'],
	  featured: true,
	  ...
	  images: ['images/apps/bots-1.png', 'images/apps/bots-2.png'],
	  featured: true,
	  techIds: [1, 14, 12]
	}, {
	  name: 'Pique',
	  ...
	  images: ['images/apps/pique-1.jpg', 'images/apps/pique-2.png', 'images/apps/pique-3.png', 'images/apps/pique-4.png'],
	  featured: true,
	  techIds: [16, 17]
	}, {
	  name: 'WhereTO',
	  ...
	  images: ['images/apps/whereto-2.png', 'images/apps/whereto-1.png'],
	  featured: true,
...
/***/ function(module, exports) {
	...
	module.exports = {"no-scrollbar":"no-scrollbar__1MOXc","img-shadow":"img-shadow__1nFWh","img-scale":"img-scale__106_n","flip-vertical":"flip-vertical__2trJd","flex":"flex__3H6b5","li-center":"li-center__1j2OI","item":"item__3Rjue","item-20":"item-20__3i8UU","item-25":"item-25__k0cKn","item-33":"item-33__1TJTW","item-50":"item-50__3s7R1","icon":"icon__3Lv-0","icon-accent":"icon-accent__2idyz","text":"text__1ifbc","caption":"caption__1c9Sm","flip-horizontal":"flip-horizontal__2gAi5","open":"open__2EWqf","menu":"menu__HkxPi","hidden":"hidden__25pw5","menu-item":"menu-item__pXjnl","menu-header":"menu-header__2LVnL","menu-icon":"menu-icon__1qbIL","logo":"logo__1Q5N1","burger":"burger__2a-Yl","logo-about":"logo-about__2N0tP","logo-work":"logo-work__1ig-C","logo-contact":"logo-contact__2Ypbv","logo-home":"logo-home__ggyvY","burger-home":"burger-home__362pu","burger-contact":"burger-contact__2oQP2","burger-work":"burger-work__2-F_c","burger-about":"burger-about__2c7S1"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cx = _bind2.default.bind(_overlay2.default);
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    var open = cx({ 'overlay': this.state.open });

	    return _react2.default.createElement('div', { className: open, onClick: this.handleClick });
	  }
	});
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"overlay":"overlay__32xrb"};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"bugfix":"bugfix__8hMC2"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _altContainer = __webpack_require__(234);
	...
	var _VideoActions = __webpack_require__(265);

	var _VideoActions2 = _interopRequireDefault(_VideoActions);

	var _VideoStore = __webpack_require__(248);

	var _VideoStore2 = _interopRequireDefault(_VideoStore);

	var _videos = __webpack_require__(268);
	...
	var Home = (function (_React$Component) {
	  ...
	  function Home(props) {
	    ...
	    _this.videos = _videos2.default;
	    _this.title = 'Evan Turner';
	    _this.description = 'Web Developer';
	    return _this;
	  }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { stores: [_VideoStore2.default] },
	          _react2.default.createElement(_Video2.default, { videos: this.videos })
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            'h3',
	            { className: cx('home-title') },
	            this.title
	          ),
	          _react2.default.createElement(
	            'h3',
	            { className: cx('home-description') },
	            this.description
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defineProperties = __webpack_require__(236);

	var implementation = __webpack_require__(240);
	var getPolyfill = __webpack_require__(245);
	var shim = __webpack_require__(246);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var foreach = __webpack_require__(239);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hasSymbols = __webpack_require__(244)();
	var toObject = Object;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _video = __webpack_require__(266);
	...
	var Video = (function (_Component) {
	  ...
	  _createClass(Video, [{
	    ...
	    value: function componentWillMount() {
	      _VideoActions2.default.init(this.props.videos);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var _VideoStore$all = _VideoStore2.default.all();

	      var props = _objectWithoutProperties(_VideoStore$all, []);

	      return _react2.default.createElement('video', _extends({ ref: function ref(player) {
	    ...
	    value: function onVideoReady() {
	      ...
	      this.player.addEventListener('playing', function () {
	        _VideoActions2.default.onReady();
	        _this3.player.playbackRate = 0.5;
	      });
	    }
	  }, {
	    key: 'onVideoEnded',
	    value: function onVideoEnded() {
	      ...
	      this.player.addEventListener('ended', function () {
	        _VideoActions2.default.setSrc();
	        _this4.player.playbackRate = 0.5;
	      });
	    }
	  }, {
	    key: 'onVideoTimeout',
	    value: function onVideoTimeout() {
	      var _this5 = this;

	      setTimeout(function () {
	        if (!_this5.props.ready) {
	          _VideoActions2.default.onReady();
	        }
	      }, 2000);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoStore = (function () {
	  function VideoStore() {
	    ...
	    this.bindActions(_VideoActions2.default);
	  ...
	  _createClass(VideoStore, [{
	    ...
	    key: 'all',
	    value: function all() {
	      var internalState = this.getState();
	...
	exports.default = _alt2.default.createStore(VideoStore, 'VideoStore');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _alt = __webpack_require__(251);

	var _alt2 = _interopRequireDefault(_alt);

	var _chromeDebug = __webpack_require__(264);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStateFunctions = __webpack_require__(255);

	var StateFunctions = _interopRequireWildcard(_utilsStateFunctions);

	var _functions = __webpack_require__(256);
	...
	var _utilsAltUtils = __webpack_require__(258);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AltStore = __webpack_require__(259);

	var _AltStore2 = _interopRequireDefault(_AltStore);

	var _StoreMixin = __webpack_require__(261);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transmitter = __webpack_require__(260);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isPromise = __webpack_require__(263);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _alt2.default.generateActions('onReady', 'onEnded', 'setSrc', 'init', 'applySrc');
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"home":"home__3jjt3","home-banner":"home-banner__2CqLh","home-title":"home-title__X1JKD","home-description":"home-description__3UMpt"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Thumbnails = __webpack_require__(276);

	var _Thumbnails2 = _interopRequireDefault(_Thumbnails);

	var _workTech = __webpack_require__(278);

	var _workMeta = __webpack_require__(281);

	var _altContainer = __webpack_require__(234);

	var _altContainer2 = _interopRequireDefault(_altContainer);

	var _ProjectActions = __webpack_require__(284);

	var _ProjectActions2 = _interopRequireDefault(_ProjectActions);

	var _ProjectStore = __webpack_require__(285);

	var _ProjectStore2 = _interopRequireDefault(_ProjectStore);

	var _CarouselStore = __webpack_require__(274);
	  ...
	  _createClass(Work, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (this.props.params.id !== nextProps.params.id) {
	        _ProjectActions2.default.setProject(nextProps.params.id);
	      }
	    }
	  }, {
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      _ProjectActions2.default.setProject(this.props.params.id);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var _ProjectStore$all = _ProjectStore2.default.all();

	      var images = _ProjectStore$all.images;
	      var activeId = _ProjectStore$all.activeId;
	      var name = _ProjectStore$all.name;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_workMeta.WorkMeta, { name: name, description: description, links: links }),
	          _react2.default.createElement(_workTech.WorkTech, { items: tech })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Slide = __webpack_require__(273);
	...
	var _CarouselActions = __webpack_require__(275);
	  ...
	  _createClass(Carousel, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (this.props.images !== nextProps.images) {
	        _CarouselActions2.default.insertImageGroup(nextProps.images);
	      }
	    }
	  }, {
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      _CarouselActions2.default.performCleanUp();
	    }
	  }, {
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      _CarouselActions2.default.insertImageGroup(this.props.images);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var slides = this.renderSlides(this.props.images);
	    ...
	    key: 'renderSlides',
	    value: function renderSlides(images) {
	      return images.map(function (image, i) {
	        var classname = _CarouselStore2.default.getClassname(image);

	        return _react2.default.createElement(_Slide2.default, { key: i, image: image, classname: classname });
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slide = (function (_Component) {
	  ...
	  function Slide(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Slide).call(this, props));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CarouselStore = (function () {
	  ...
	  _createClass(CarouselStore, [{
	    key: 'insertImageGroup',
	    value: function insertImageGroup(images) {
	      this.images = images;
	    ...
	    key: 'performCleanUp',
	    value: function performCleanUp() {
	      clearInterval(this.interval);
	      clearTimeout(this.timeout);
	    }
	  }, {
	    key: 'runTransition',
	    value: function runTransition() {
	      var _this2 = this;
	    ...
	    key: 'getClassname',
	    value: function getClassname(image) {
	...
	exports.default = _alt2.default.createStore(CarouselStore, 'CarouselStore');
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _alt2.default.generateActions('performCleanUp', 'insertImageGroup', 'getClassname');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Thumbnail = __webpack_require__(277);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.WorkTech = undefined;

	var _react = __webpack_require__(5);

	var _react2 = _interopRequireDefault(_react);

	var _iconTech = __webpack_require__(279);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var WorkTech = exports.WorkTech = _react2.default.createClass({
	  displayName: 'WorkTech',
	  getDefaultProps: function getDefaultProps() {
	    return {
	      title: 'Made with'
	    };
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_iconTech.TechItems, { items: items, width: 'item-25' })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TechItems = exports.TechItems = _react2.default.createClass({
	  displayName: 'TechItems',
	  getDefaultProps: function getDefaultProps() {
	    return {
	      width: 'item'
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.WorkMeta = undefined;

	var _react = __webpack_require__(5);

	var _react2 = _interopRequireDefault(_react);

	var _iconLinks = __webpack_require__(282);

	var _iconLinks2 = _interopRequireDefault(_iconLinks);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var WorkMeta = exports.WorkMeta = _react2.default.createClass({
	  displayName: 'WorkMeta',
	  getInitialState: function getInitialState() {
	    return _extends({}, this.props);
	  },
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    return this.setState(_extends({}, nextProps));
	  },
	  setupLinks: function setupLinks() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_iconLinks2.default, { items: links, classname: 'square' })
	    );
	  },
	  render: function render() {
	    var _state = this.state;
	    ...
	    var projectLinks = this.setupLinks();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iconLink = __webpack_require__(283);
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      items.map(function (obj, i) {
	        return _react2.default.createElement(_iconLink2.default, {
	          key: i,
	          classname: classname,
	          icon: obj.icon,
	          url: obj.url
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProjectStore = (function () {
	  ...
	  _createClass(ProjectStore, [{
	    ...
	    key: 'setThumbnails',
	    value: function setThumbnails() {
	      var _this = this;

	      this.thumbnails = this.projects.map(function (thumb) {
	        return {
	          id: thumb.id,
	          image: _this.getRelativePath(thumb.thumbnail)
	        };
	      });
	    }
	  }, {
	    key: 'setTech',
	    value: function setTech(ids) {
	      var tech = [];
	      ...
	      try {
	        for (var _iterator = ids[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          ...
	          try {
	            for (var _iterator2 = this.software[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	              var obj = _step2.value;
	    ...
	    key: 'setSlides',
	    value: function setSlides(images) {
	      var _this2 = this;

	      return images.map(function (image) {
	        return _this2.getRelativePath(image);
	      });
	    }
	  }, {
	    key: 'setProject',
	    value: function setProject() {
	      var projectId = arguments.length <= 0 || arguments[0] === undefined ? 1 : arguments[0];

	      if (this.thumbnails === null) {
	        this.setThumbnails();
	      }

	      var result = this.getProjectById(projectId);
	      var tech = this.setTech(result.techIds);
	      var images = this.setSlides(result.images);
	      var project = (0, _objectAssign2.default)({}, {
	        images: images,
	        tech: tech,
	        name: result.name,
	    ...
	    key: 'getRelativePath',
	    value: function getRelativePath(absolutePath) {
	      var prefix = 'src/assets/';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _aboutInfo = __webpack_require__(287);

	var _aboutStats = __webpack_require__(288);

	var _aboutTech = __webpack_require__(292);

	var _aboutBio = __webpack_require__(293);

	var _aboutHeader = __webpack_require__(294);
	...
	var About = exports.About = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { className: 'about' },
	      _react2.default.createElement(_aboutHeader.AboutHeader, null),
	      _react2.default.createElement(_aboutBio.AboutBio, null),
	      _react2.default.createElement(
	        _aboutInfo.AboutInfo,
	        null,
	        _react2.default.createElement(_aboutTech.AboutTech, null),
	        _react2.default.createElement(_aboutStats.AboutStats, null)
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AboutInfo = exports.AboutInfo = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.AboutStats = undefined;

	var _react = __webpack_require__(5);

	var _react2 = _interopRequireDefault(_react);

	var _iconCount = __webpack_require__(289);

	var _aboutTitle = __webpack_require__(290);

	var _stats = __webpack_require__(291);

	var _stats2 = _interopRequireDefault(_stats);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var AboutStats = exports.AboutStats = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var statsTitle = _props.statsTitle;

	    return _react2.default.createElement(
	      'div',
	      { className: 'about-stats' },
	      _react2.default.createElement(_aboutTitle.AboutTitle, { title: statsTitle }),
	      _react2.default.createElement(_iconCount.CounterItems, { items: stats, width: 'item-50' })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CounterItems = exports.CounterItem = undefined;
	...
	var CounterItem = exports.CounterItem = _react2.default.createClass({
	  ...
	  increment: function increment() {
	    ...
	    if (this.state.count >= this.props.number) {
	      ...
	      this.incTimer = setTimeout(function () {
	        _this.setState({
	          count: _this.state.count + 50
	        });
	        _this.increment();
	      }, 50);
	    }
	...
	var CounterItems = exports.CounterItems = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      { className: 'flex' },
	      items.map(function (obj, i) {
	        return _react2.default.createElement(CounterItem, {
	          key: i,
	          number: obj.number,
	          caption: obj.caption,
	          width: width
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AboutTitle = exports.AboutTitle = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AboutTech = exports.AboutTech = _react2.default.createClass({
	  displayName: 'AboutTech',
	  getDefaultProps: function getDefaultProps() {
	    return {
	      techTitle: 'Tools',
	      tech: (0, _helpers.getTechItems)()
	    };
	  },
	  render: function render() {
	    var _props = this.props;
	    var techTitle = _props.techTitle;
	    var tech = _props.tech;

	    return _react2.default.createElement(
	      'div',
	      { className: 'about-tech' },
	      _react2.default.createElement(_aboutTitle.AboutTitle, { title: techTitle }),
	      _react2.default.createElement(_iconTech.TechItems, { items: tech, width: 'item-20' })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AboutBio = exports.AboutBio = _react2.default.createClass({
	  displayName: 'AboutBio',
	  getDefaultProps: function getDefaultProps() {
	    return {
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'bio' },
	      _react2.default.createElement(_aboutTitle.AboutTitle, { title: title }),
	      _react2.default.createElement(
	        'div',
	        { className: 'paragraph' },
	        text
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AboutHeader = exports.AboutHeader = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'header' },
	      _react2.default.createElement('img', { className: 'about-image', src: image })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _links = __webpack_require__(296);
	  ...
	  _createClass(Contact, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_iconLinks2.default, { items: this.links, classname: 'circle' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cx = _bind2.default.bind(_spinner2.default);
	...
	var Spinner = (function (_React$Component) {
	  ...
	  function Spinner(props) {
	    ...
	    _this.image = 'src/assets/images/site/ev-av.png';
	    _this.state = {
	      ready: false,
	      done: false
	    };
	  ...
	  _createClass(Spinner, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: animation },
	        _react2.default.createElement('div', { className: cx('animation') }),
	        _react2.default.createElement(
	          'div',
	          { className: cx('spinner-logo') },
	          _react2.default.createElement('img', { className: cx('spinner-image'), src: this.image })
	        )
	      );
	    }
	  }, {
	    ...
	    value: function removeSpinner() {
	      ...
	      setTimeout(function () {
	        return _this3.setState({ done: true });
	      }, 1000);
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"no-scrollbar":"no-scrollbar__caWLW","img-shadow":"img-shadow__35FTG","img-scale":"img-scale__3gKT8","flip-vertical":"flip-vertical__H214v","hidden":"hidden__3by_s","spinner":"spinner__2Cixj","spinner-logo":"spinner-logo__35jqY","spiner-image":"spiner-image__2355i","animation":"animation__xqZ2w","rotation":"rotation__3_102"};
