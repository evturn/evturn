	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('img', { ref: 'img', src: __webpack_require__(339), onload: function onload(e) {
	          _this.handleImageLoad(e);
	        } }),
	      _react2.default.createElement(
	        'ul',
	        { className: 'link-items list-icons animated fadeIn' },
	        this.state.links.map(function (result, i) {
...
//# sourceMappingURL=0.96aed0f118587068cf1f.hot-update.js.map