...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
	    console.log('called!');
	    return this.state.backdrop !== nextProps;
	  },
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { style: { backgroundImage: 'url(' + this.state.backdrop + ')' }, className: 'page-wrapper' },
	      _react2.default.createElement(
	        'ul',
	        { ref: function ref(list) {
	            return _this.list = list;
	          }, className: 'link-items list-icons animated fadeIn' },
	        this.state.links.map(function (result) {
...
//# sourceMappingURL=0.e59b3afaae4f4bd43aa1.hot-update.js.map