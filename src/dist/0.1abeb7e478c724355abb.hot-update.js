...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContactLinks = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement('ul', { className: 'link-items list-icons animated fadeIn' });
	  }
	});
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { style: { backgroundImage: 'url(' + this.props.backdrop + ')' }, className: 'page-wrapper' },
	      _react2.default.createElement(ContactLinks, { links: this.props.links }),
...
//# sourceMappingURL=0.1abeb7e478c724355abb.hot-update.js.map