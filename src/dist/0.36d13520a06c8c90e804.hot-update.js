	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ContactLinks,
	        null,
	        _react2.default.createElement(ContactLink, { key: this.props.name, url: this.props.url, icon: this.props.icon })
	      )
	    );
	  }
	});
...
//# sourceMappingURL=0.36d13520a06c8c90e804.hot-update.js.map